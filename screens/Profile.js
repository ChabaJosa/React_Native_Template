    ...
    return (
      <Block flex style={styles.profile}>
        <Block flex>
          ...
          <LinearGradient colors={['rgba(255,255,255,0)', 'rgba(0,0,5,5)']} style={styles.gradient} />  
            <Block flex style={styles.profileDetails}>
              <Block style={styles.profileTexts}>
                <Text color="white" size={28} style={{ paddingBottom: 8 }}>John Smith</Text>
                <Block row space="between">
                  <Block row>
                    {/* <Block middle style={styles.pro}>
                      <Text size={16} color="white">Pro</Text>
                    </Block> */}
                    <Text color="white" size={16} muted style={styles.seller}>Gold Partner</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <Block row space="between" style={{ padding: theme.SIZES.BASE, }}>
              ...
              <Block middle>
                ...
                <Text muted size={12}>Invoices & Offers</Text>
              </Block>
              <Block middle>
                <Text bold size={12} style={{marginBottom: 8}}>2</Text>
                <Text muted size={12}>Notifications</Text>
              </Block>
            </Block>
            <Block row space="between" style={{ paddingVertical: 16, alignItems: 'baseline' }}>
              <Text size={16}>Transactions</Text>
